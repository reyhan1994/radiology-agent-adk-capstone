...
Otherwise uses the ImageNet-pretrained ResNet18 backbone and a fresh fc layer.
This agent is intended for demonstration/Capstone — for real competition you should train
properly and provide trained weights in models/chest_classifier.pt.
"""
