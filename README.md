...
![Agent Architecture](Demoimage/55.png)
...
```
                  ...
                  │ uploads chest X-ray
                  ▼
    [Interactive_Radiology_Agent]
                  │
      ┌───────────┼────────────┐
      ▼           ▼            ▼
[Image Analysis] [Report Gen] [Coding Agent]
      │               │           │
      │               │           │
      ▼               ▼           ▼
 annotated         radiology    model training/
 image & heatmap   report       evaluation outputs
                  │
                  ▼
           [Memory Agent]
                  │
                  ▼
      stores case history for
